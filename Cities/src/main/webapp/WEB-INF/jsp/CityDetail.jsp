		...
		<div class="w3-row">
			...
			<div class="w3-quarter">
				<%
							...
							{
						%>
				<a href="Index?cmd=citizen&id=<%=c.ID%>" style="margin-top: 10px;">
			...
			<div class="w3-quarter">
				<a href="Index?cmd=deletebuilding&id=<%=b.ID%>&cityid=<%=b.cityID%>"
