...
/**
 * 
 * Io sono un controller di secondo livello, vengo chiamato dalla DISPATCHER
 * SERVLET e mi occupo delle richieste relative alle città
 * 
 * @author Stefano
 *
 */
public class CityController
{
	...
	/**
	 * L'utente mi sta inviando 5 parametri - Se sono corretti, inserisco la città e
	 * vado alla pagina principale _ Se NON lo sono, genero un messaggio di errore e
	 * torno alla form
	 * 
	 * @param request
	 * @param response
	 ...
	 * @throws IOException
	 */
	public void newCity(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
